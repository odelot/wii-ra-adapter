...
/* Disable 3DS CIA/NCCH encryption hashing — not needed for GameCube adapter
 * and requires platform-specific key derivation callbacks. */
#ifndef RC_HASH_NO_ENCRYPTED
#  define RC_HASH_NO_ENCRYPTED
#endif
